      ...
      <div className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
        ...
        >
          ...
          <img
            src={aboutImage}
            alt="About Me"
            className="relative rounded-2xl w-full h-[420px] sm:h-[500px] md:h-[450px] object-cover border border-emerald-400/40"
          />
        </motion.div>
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-300 leading-relaxed mb-4">
            ...
            a Full Stack AI Engineer focused on generative AI and LLM-powered applications, driven 
            to build technology that solves real-world problems. With a strong foundation in software 
            development and machine learning, I develop intelligent, scalable systems that balance 
            performance, usability, and accuracy.
          </p>

          <p className="text-sm sm:text-md md:text-lg text-gray-400 leading-relaxed mb-6">
            I enjoy turning complex ideas into practical, user-focused products and continuously 
            improving through hands-on projects, hackathons, and experimentation. I am always 
            looking to build meaningful solutions that create real impact.
          </p>
